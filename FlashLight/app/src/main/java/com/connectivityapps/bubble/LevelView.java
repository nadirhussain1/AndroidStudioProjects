...
public class LevelView extends SurfaceView implements SurfaceHolder.Callback, OnTouchListener {
    ...
    public void surfaceCreated(SurfaceHolder holder) {
    	...
    	if (painter == null) {
            painter=new LevelPainter(holder, getContext(), new Handler(), getWidth(), getHeight(),true,DisplayType.valueOf(FlashPreferences.getInstance(BubbleFragment.context).getBubbleDisplayOption()),1,false,false);
	    }
    }
