...
public class ActivityPlaceLocation extends Utils implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.place_location_activity);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        try {
            ...
            for (int i = 0; i < HalalPlaceActivity.latList.size(); i++) {
                // Adding a marker


                // Adding a marker
                MarkerOptions marker = new MarkerOptions().position(new LatLng(
                        HalalPlaceActivity.latList.get(i),
                        HalalPlaceActivity.longList.get(i)));

                // changing marker color
                BitmapDescriptor locationIcon = BitmapDescriptorFactory.fromResource(R.drawable.location_icon);
