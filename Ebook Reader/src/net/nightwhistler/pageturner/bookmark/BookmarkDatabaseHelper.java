...
public class BookmarkDatabaseHelper extends SQLiteOpenHelper {
    ...
    private static BookmarkDatabaseHelper bookmarkDatabaseHelper = null;

    public static BookmarkDatabaseHelper getInstance(Context context) {
        synchronized (BookmarkDatabaseHelper.class) {
            if (bookmarkDatabaseHelper == null) {
