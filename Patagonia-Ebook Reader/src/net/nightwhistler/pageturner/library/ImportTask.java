...
public class ImportTask extends QueueableAsyncTask<File, Integer, Void> implements OnCancelListener {
	...
	protected boolean copyToLibrary;
	
	protected List<String> errors = new ArrayList<>();
	
	private static final Logger LOG = LoggerFactory.getLogger(ImportTask.class);
	
	protected static final int UPDATE_FOLDER = 1;
	protected static final int UPDATE_IMPORT = 2;
	
	private int foldersScanned = 0;
	protected int booksImported = 0;

    protected boolean emptyLibrary;
    protected boolean silent;
	
	protected String importFailed = null;
    ...
    protected void processFile( File file, List<File> items ) {
    ...
    protected boolean importBook(File file) {
