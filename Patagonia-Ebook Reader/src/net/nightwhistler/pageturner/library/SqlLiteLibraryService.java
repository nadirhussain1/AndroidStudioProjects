...
public class SqlLiteLibraryService implements LibraryService {
	...
	protected static final int THUMBNAIL_HEIGHT = 250;
	protected static final long MAX_COVER_SIZE = 1024 * 1024; //Max 1Mb


	protected LibraryDatabaseHelper helper;
	private Configuration config;

	public SqlLiteLibraryService(Context context){
		config = Configuration.getInstance(context);
		helper=LibraryDatabaseHelper.getInstance(context);
	}
	...
	public void storeBookByCoverFile( String fileNameUrl, byte[] cover, Book book, boolean updateLastRead, boolean copyFile ) throws IOException {
		Log.d("LibraryDatabase", "Inside storeBookByCoverFile LibraryService");
	}
	...
	protected Option<File> copyToLibrary( String fileName, String author, String title) throws IOException {
